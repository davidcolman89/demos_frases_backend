...
namespace {
	...
	class Excel extends \Maatwebsite\Excel\Facades\Excel{
		 ...
		 * @static 
		 */
		 public static function __construct($excel, $reader, $writer){
			//Method inherited from \Maatwebsite\Excel\Excel
			 \Maatwebsite\Excel\Excel::__construct($excel, $reader, $writer);
		 }
		 ...
		 * @static 
		 */
		 public static function create($title, $callback = false){
			//Method inherited from \Maatwebsite\Excel\Excel
			return \Maatwebsite\Excel\Excel::create($title, $callback);
		 }
		 ...
		 * @static 
		 */
		 public static function load($file, $callback = false, $encoding = false){
			//Method inherited from \Maatwebsite\Excel\Excel
			 \Maatwebsite\Excel\Excel::load($file, $callback, $encoding);
		 }
		 ...
		 */
		 public static function __call($method, $params){
			//Method inherited from \Maatwebsite\Excel\Excel
			return \Maatwebsite\Excel\Excel::__call($method, $params);
		 }
